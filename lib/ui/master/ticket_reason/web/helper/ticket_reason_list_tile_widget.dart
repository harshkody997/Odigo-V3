...
class TicketReasonListTileWidget extends StatelessWidget {
  final GestureTapCallback? onEditTap;
  /// TODO During api integration make & pass TicketReasonModel constructor
  const TicketReasonListTileWidget({super.key, this.onEditTap});
    ...
    return Container(
      ...
      child: Table(
        ...
        columnWidths: const {
          ...
          1: FlexColumnWidth(2), /// platform type
          2: FlexColumnWidth(6), /// ticket reason
          3: FlexColumnWidth(1), /// edit
        },
        children: [
          TableRow(children: [
            CommonCupertinoSwitch(switchValue: true, onChanged: (value){}).alignAtCenterLeft(),
            CommonTableValueWidget(valueText: 'CLIENT',),
            CommonTableValueWidget(valueText: 'Customer Support',),
            Container(
              child: InkWell(
                onTap: onEditTap,
                child: CommonSVG(
