...
class CommonDashboardOverviewLineChart extends ConsumerStatefulWidget {
  final List<LineGraphData> lineGraphData;

  const CommonDashboardOverviewLineChart({super.key, required this.lineGraphData});

  @override
  ConsumerState<CommonDashboardOverviewLineChart> createState() => _AllTimeLineChartDataState();
}

class _AllTimeLineChartDataState extends ConsumerState<CommonDashboardOverviewLineChart> {
  @override
                    ...
                    lineBarsData: [
                      LineChartBarData(
                        ...
                        belowBarData: BarAreaData(
                          show: true,
                          gradient: LinearGradient(begin: Alignment.bottomCenter, end: Alignment.topCenter, colors: [AppColors.black.withValues(alpha: 0), AppColors.black.withValues(alpha: 0.1)]),
                        ),
                      ),
                    ],
