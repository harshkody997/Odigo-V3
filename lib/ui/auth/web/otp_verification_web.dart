...
import 'package:odigov3/ui/auth/web/helper/otp_verification_form.dart';
...
class OtpVerificationWeb extends ConsumerStatefulWidget {
  String? email;
   OtpVerificationWeb({super.key,this.email});
...
class _OtpVerificationWebState extends ConsumerState<OtpVerificationWeb> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: _bodyWidget(),resizeToAvoidBottomInset: false,
            ...
            child: Material(
              ...
              CommonAuthBackground(
               ...
               // height: context.height * 0.56,
                ...
                content:
                OtpVerificationForm(email: widget.email,)
              ),
            ),
        ),
      ],
